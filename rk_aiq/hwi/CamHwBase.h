...
namespace RkCam
{
    ...
    class CamHwBase : public ICamHw, public PollCallback
    {
      public:
        explicit CamHwBase();
        virtual ~CamHwBase();
        ...
        virtual XCamReturn capture_raw_ctl(capture_raw_t type, int count = 0, const char* capture_dir = nullptr,
        ...
        virtual int getCamPhyId()
        {
            return mCamPhyId;
        }
        virtual void setGroupMode(bool bGroup, bool bMain)
        {
            mIsGroupMode = bGroup;
            mIsMain = bMain;
        }
