...
namespace RkCam
{
    ...
    class ImageOperator
    {
      public:
        ...
        virtual XCamReturn crop(const img_buffer_t& src, img_buffer_t& dst, img_rect_t rect, int sync = 1);
        virtual XCamReturn resize(const img_buffer_t& src, img_buffer_t& dst, double fx, double fy,
                                  int interpolation = 0, int sync = 1);
        virtual XCamReturn cvtcolor(img_buffer_t& src, img_buffer_t& dst, int sfmt, int dfmt, int mode, int sync = 1);
        virtual XCamReturn rotate(const img_buffer_t& src, img_buffer_t& dst, int rotation, int sync = 1);
    ...
    class ImageProcessor
    {
      public:
        ...
        XCamReturn cvtcolor(img_buffer_t& src, img_buffer_t& dst, int sfmt, int dfmt, int mode, int sync = 1);
