...
namespace RkCam
{
    ...
    class IspParamsSplitter
    {
      public:
        ...
        template <typename U> XCamReturn SplitIspParams(U* orig_isp_params, U* isp_params);

      private:
        // ae
        template <typename U> XCamReturn SplitAecParams(U* ori, U* left, U* right);
        template <typename U> XCamReturn SplitRawHistLiteParams(U* ori, U* left, U* right);
        template <typename U> XCamReturn SplitRawHistBigParams(U* ori, U* left, U* right);
        template <typename U> XCamReturn SplitRawAeLiteParams(U* ori, U* left, U* right);
        template <typename U> XCamReturn SplitRawAeBigParams(U* ori, U* left, U* right);

        // awb
        template <typename U> XCamReturn SplitAwbParams(U* ori, U* left, U* right);
        template <typename U> XCamReturn SplitAfParams(U* ori, U* left, U* right);
        // LSC
        template <typename U> XCamReturn SplitAlscParams(U* ori, U* left, U* right);
