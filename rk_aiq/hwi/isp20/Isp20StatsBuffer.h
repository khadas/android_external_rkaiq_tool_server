...
namespace RkCam
{
    ...
    class Isp20StatsBuffer : public V4l2BufferProxy
    {
      public:
        explicit Isp20StatsBuffer(SmartPtr<V4l2Buffer> buf, SmartPtr<V4l2Device>& device, SmartPtr<BaseSensorHw> sensor,
                                  ICamHw* camHw, SmartPtr<RkAiqAfInfoProxy> AfParams,
    ...
    class SofEventBuffer : public BufferProxy
    {
      public:
        explicit SofEventBuffer(SmartPtr<SofEventData>& buf, SmartPtr<V4l2Device>& device);
