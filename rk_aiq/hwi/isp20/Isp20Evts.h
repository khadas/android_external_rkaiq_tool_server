...
namespace RkCam
{
    ...
    class Isp20Evt : public ispHwEvt_t, public BufferData
    {
      public:
        Isp20Evt(ICamHw* camHw, SmartPtr<SensorHw> sensor) : mSensor(sensor), mCamHw(camHw), mTimestamp(-1)
        {
        }
        virtual ~Isp20Evt()
        {
    ...
    class Isp20EvtBuffer : public BufferProxy
    {
      public:
        explicit Isp20EvtBuffer(SmartPtr<Isp20Evt>& buf, SmartPtr<V4l2Device>& device) : BufferProxy(buf)
        {
        }
