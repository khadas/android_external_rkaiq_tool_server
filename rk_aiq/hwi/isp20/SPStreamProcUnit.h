...
namespace RkCam
{
    ...
    class SPStreamProcUnit : public RKStream, public PollCallback
    {
      public:
        ...
        XCamReturn prepare(CalibDbV2_Af_LdgParam_t* ldg_param, CalibDbV2_Af_HighLightParam_t* highlight, int width = 0,
                           int height = 0, int stride = 0);
        void set_devices(CamHwIsp20* camHw, SmartPtr<V4l2SubDevice> isp_core_dev, SmartPtr<V4l2SubDevice> ispp_dev,
                         SmartPtr<V4l2SubDevice> lensdev);
