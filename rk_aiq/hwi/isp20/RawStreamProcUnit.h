...
namespace RkCam
{
    ...
    class RawStreamProcUnit : public PollCallback
    {
      public:
        ...
        void send_sync_buf(SmartPtr<V4l2BufferProxy>& buf_s, SmartPtr<V4l2BufferProxy>& buf_m,
        ...
        void setPollCallback(PollCallback* cb)
        {
            _PollCallback = cb;
        }
        // from PollCallback
    ...
    class RawProcThread : public Thread
    {
      public:
        RawProcThread(RawStreamProcUnit* handle) : Thread("RawProcThread"), _handle(handle)
        {
        }
