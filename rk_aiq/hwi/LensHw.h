...
#ifdef CONFIG_COMPAT
    #define RK_VIDIOC_COMPAT_VCM_TIMEINFO _IOR('V', BASE_VIDIOC_PRIVATE + 0, struct rk_cam_compat_vcm_tim)
    #define RK_VIDIOC_COMPAT_IRIS_TIMEINFO _IOR('V', BASE_VIDIOC_PRIVATE + 1, struct rk_cam_compat_vcm_tim)
    #define RK_VIDIOC_COMPAT_ZOOM_TIMEINFO _IOR('V', BASE_VIDIOC_PRIVATE + 2, struct rk_cam_compat_vcm_tim)
    #define RK_VIDIOC_COMPAT_ZOOM1_TIMEINFO _IOR('V', BASE_VIDIOC_PRIVATE + 11, struct rk_cam_compat_vcm_tim)
#endif
...
#define LENS_SUBM (0x10)
    ...
    class LensHw : public V4l2SubDevice
    {
      public:
        ...
        XCamReturn setLowPassFv(uint32_t sub_shp4_4[RKAIQ_RAWAF_SUMDATA_NUM],
    ...
    class LensHwHelperThd : public Thread
    {
      public:
        LensHwHelperThd(LensHw* lenshw, int id) : Thread("LensHwHelperThread"), mLensHw(lenshw), mId(id){};
        ~LensHwHelperThd()
        {
            mAttrQueue.clear();
        };
