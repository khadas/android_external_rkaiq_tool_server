...
ANRresult_t ynr_config_setting_param(RKAnr_Ynr_Params_s* pParams, CalibDb_YNR_2_t* pCalibdb, char* param_mode,
                                     char* snr_name);

ANRresult_t init_ynr_params(RKAnr_Ynr_Params_s* pYnrParams, CalibDb_YNR_2_t* pYnrCalib, int mode_idx, int setting_idx);

ANRresult_t select_ynr_params_by_ISO(RKAnr_Ynr_Params_t* stYnrParam, RKAnr_Ynr_Params_Select_t* stYnrParamSelected,
                                     ANRExpInfo_t* pExpInfo, short bitValue);

ANRresult_t ynr_fix_transfer(RKAnr_Ynr_Params_Select_t* ynr, RKAnr_Ynr_Fix_t* pNrCfg, float gain_ratio,
                             float fStrength);
...
ANRresult_t init_ynr_params_json(RKAnr_Ynr_Params_s* pYnrParams, CalibDbV2_YnrV1_t* pYnrCalib, int calib_idx,
                                 int tuning_idx);

ANRresult_t ynr_config_setting_param_json(RKAnr_Ynr_Params_s* pParams, CalibDbV2_YnrV1_t* pCalibdb, char* param_mode,
                                          char* snr_name);
