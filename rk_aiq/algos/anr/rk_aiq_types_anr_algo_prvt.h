...
#define F_DECI_GAIN_GLB_SQRT_INV                                                                                       \
    13 // (F_INTE_GAIN_SQRT + F_DECI_GAIN_SQRT)     // 13   // (F_INTE_GAIN_SQRT + F_DECI_GAIN_SQRT + 4) is better
       // jmj_3dnr
...
#define F_DECI_LUMA_W_IN_CHROMA                                                                                        \
    (F_ACCURATE_FLG_LUMA_W_IN_CHROMA ? F_DECI_LUMA_W_IN_CHROMA_ACCURATE : F_DECI_LUMA_W_IN_CHROMA_REAL)
...
#define F_DECI_TXT_THRD_RATIO                                                                                          \
    (F_ACCURATE_FLG_TXT_THRD_RATIO ? F_DECI_TXT_THRD_RATIO_ACCURATE : F_DECI_TXT_THRD_RATIO_REAL)
