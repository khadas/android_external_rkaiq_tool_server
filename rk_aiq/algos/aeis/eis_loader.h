...
namespace RkCam
{
    ...
    using getOriginalMeshXY = void (*)(int image_width, int image_height, double clip_ratio_x, double clip_ratio_y,
                                       meshxyFEC* pmesh_fec);
    ...
    using dvsPutImuFrame = int (*)(struct dvsEngine* engine, mems_sensor_event_s* pimu_data, int buff_number);
