...
namespace RkCam
{
    ...
    class EisAlgoAdaptor : public std::enable_shared_from_this<EisAlgoAdaptor>
    {
      public:
        ...
        XCamReturn Prepare(const rk_aiq_mems_sensor_intf_t* mems_sensor_intf, const isp_drv_share_mem_ops_t* mem_ops);
        bool IsValid()
        {
            return valid_;
        }
      ...
      private:
        ...
        XCamReturn CreateFecRemapBackend(const FecMeshConfig& config, const isp_drv_share_mem_ops_t* mem_ops);
