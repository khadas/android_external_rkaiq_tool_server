...
Asharp3_result_t sharp_get_setting_by_name_V3(struct list_head* pSettingList, char* name,
                                              Calibdb_Sharp_params_V3_t** ppSetting);

Asharp3_result_t sharp_config_setting_param_V3(RK_SHARP_Params_V3_t* pParams, struct list_head* pCalibdbList,
...
Asharp3_result_t sharp_select_params_by_ISO_V3(RK_SHARP_Params_V3_t* pParams, RK_SHARP_Params_V3_Select_t* pSelect,
...
Asharp3_result_t sharp_init_params_json_V3(RK_SHARP_Params_V3_t* pSharpParams, CalibDbV2_SharpV3_t* pCalibdbV2,
                                           int tuning_idx);

Asharp3_result_t sharp_config_setting_param_json_V3(RK_SHARP_Params_V3_t* pParams, CalibDbV2_SharpV3_t* pCalibdbV2,
                                                    char* param_mode, char* snr_name);
