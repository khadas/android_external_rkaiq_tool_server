...
Asharp3_result_t Asharp_ConfigSettingParam_V3(Asharp_Context_V3_t* pAsharpCtx, Asharp3_ParamMode_t eParamMode,
                                              int snr_mode);

Asharp3_result_t Asharp_ParamModeProcess_V3(Asharp_Context_V3_t* pAsharpCtx, Asharp3_ExpInfo_t* pExpInfo,
                                            Asharp3_ParamMode_t* mode);
