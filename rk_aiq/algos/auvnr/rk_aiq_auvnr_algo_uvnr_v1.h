...
Auvnr_result_t uvnr_config_setting_param_v1(RK_UVNR_Params_V1_t* pParams, CalibDb_UVNR_2_t* pCalibdb, char* param_mode,
                                            char* snr_name);

Auvnr_result_t init_uvnr_params_v1(RK_UVNR_Params_V1_t* pParams, CalibDb_UVNR_2_t* pCalibdb, int mode_idx,
                                   int setting_idx);

Auvnr_result_t select_uvnr_params_by_ISO_v1(RK_UVNR_Params_V1_t* stRKUVNrParams,
                                            RK_UVNR_Params_V1_Select_t* stRKUVNrParamsSelected,
                                            Auvnr_ExpInfo_t* pExpInfo);

Auvnr_result_t uvnr_fix_transfer_v1(RK_UVNR_Params_V1_Select_t* uvnr, RK_UVNR_Fix_V1_t* pNrCfg,
                                    Auvnr_ExpInfo_t* pExpInfo, float gain_ratio, float fStrength);

Auvnr_result_t uvnr_fix_Printf_v1(RK_UVNR_Fix_V1_t* pNrCfg);

Auvnr_result_t uvnr_config_setting_param_json_v1(RK_UVNR_Params_V1_t* pParams, CalibDbV2_UVNR_t* pCalibdb,
