...
// anr get result
Abayertnr_result_V2_t Abayertnr_GetProcResult_V2(Abayertnr_Context_V2_t* pAbayertnrCtx,
                                                 Abayertnr_ProcResult_V2_t* pANRResult);

Abayertnr_result_V2_t Abayertnr_ConfigSettingParam_V2(Abayertnr_Context_V2_t* pAbayertnrCtx,
                                                      Abayertnr_ParamMode_V2_t eParamMode, int snr_mode);

Abayertnr_result_V2_t Abayertnr_ParamModeProcess_V2(Abayertnr_Context_V2_t* pAbayertnrCtx,
                                                    Abayertnr_ExpInfo_V2_t* pExpInfo, Abayertnr_ParamMode_V2_t* mode);
