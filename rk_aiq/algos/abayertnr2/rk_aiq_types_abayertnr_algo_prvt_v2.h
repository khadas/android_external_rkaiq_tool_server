...
#ifndef _RK_AIQ_TYPES_ABAYERTNR_ALGO_PRVT_V2_H_
#define _RK_AIQ_TYPES_ABAYERTNR_ALGO_PRVT_V2_H_
...
// anr context
typedef struct Abayertnr_Context_V2_s {
    ...
    bool isIQParaUpdate;
    bool isGrayMode;
    Abayertnr_ParamMode_V2_t eParamMode;
    int prepare_type;
