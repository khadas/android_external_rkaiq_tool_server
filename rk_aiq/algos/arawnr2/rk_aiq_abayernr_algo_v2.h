...
Abayernr_result_t Abayernr_ConfigSettingParam_V2(Abayernr_Context_V2_t* pAbayernrCtx, Abayernr_ParamMode_t eParamMode,
                                                 int snr_mode);

Abayernr_result_t Abayernr_ParamModeProcess_V2(Abayernr_Context_V2_t* pAbayernrCtx, Abayernr_ExpInfo_t* pExpInfo,
                                               Abayernr_ParamMode_t* mode);
