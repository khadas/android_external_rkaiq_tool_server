...
#ifndef _RK_AIQ_TYPES_ABAYER2DNR_ALGO_PRVT_V2_H_
#define _RK_AIQ_TYPES_ABAYER2DNR_ALGO_PRVT_V2_H_
...
// anr context
typedef struct Abayer2dnr_Context_V2_s {
    ...
    Abayer2dnr_ProcResult_V2_t stProcResult;

    rk_aiq_bayer2dnr_strength_v2_t stStrength;

    bool isIQParaUpdate;
    bool isGrayMode;
    Abayer2dnr_ParamMode_V2_t eParamMode;
    int prepare_type;
