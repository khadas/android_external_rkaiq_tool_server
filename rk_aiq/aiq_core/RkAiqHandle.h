    ...
    */
    ...
    class RkAiqHandle
    {
      public:
        ...
        const int getAlgoId() const
        {
            return mDes->id;
        }
        const int getAlgoType() const
        {
            return mDes->type;
        }
    ...
    template <typename T> RkAiqHandle* createT(RkAiqAlgoDesComm* des, RkAiqCore* aiqCore)
    {
        return new T(des, aiqCore);
    }

    struct RkAiqHandleFactory {
        typedef std::map<std::string, RkAiqHandle* (*)(RkAiqAlgoDesComm* des, RkAiqCore* aiqCore)> map_type;
        ...
        static RkAiqHandle* createInstance(std::string const& s, RkAiqAlgoDesComm* des, RkAiqCore* aiqCore)
        {
    ...
    template <typename T> struct RkAiqHandleRegister : RkAiqHandleFactory {
        RkAiqHandleRegister(std::string const& s) : s_(s)
        {
