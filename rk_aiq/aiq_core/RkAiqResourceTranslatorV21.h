...
namespace RkCam
{
    ...
    class RkAiqResourceTranslatorV21 : public RkAiqResourceTranslator
    {
      public:
        ...
        XCamReturn translateOrbStats(const SmartPtr<VideoBuffer>& from, SmartPtr<RkAiqOrbStatsProxy>& to)
        {
            return XCAM_RETURN_BYPASS;
        };
        XCamReturn translateAtmoStats(const SmartPtr<VideoBuffer>& from, SmartPtr<RkAiqAtmoStatsProxy>& to)
        {
            return XCAM_RETURN_BYPASS;
        };
