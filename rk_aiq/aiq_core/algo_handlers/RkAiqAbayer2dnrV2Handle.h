 ...
 */
#ifndef _RK_AIQ_BAYER2DNR_HANDLE_INT_H_
#define _RK_AIQ_BAYER2DNR_HANDLE_INT_H_
...
namespace RkCam
{
    ...
    class RkAiqAbayer2dnrV2HandleInt : virtual public RkAiqHandle
    {
      public:
        explicit RkAiqAbayer2dnrV2HandleInt(RkAiqAlgoDesComm* des, RkAiqCore* aiqCore) : RkAiqHandle(des, aiqCore)
        {
