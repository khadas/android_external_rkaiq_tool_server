 ...
 */
#ifndef _RK_AIQ_CNR_V2_HANDLE_INT_H_
#define _RK_AIQ_CNR_V2_HANDLE_INT_H_
...
namespace RkCam
{
    ...
    class RkAiqAcnrV2HandleInt : virtual public RkAiqHandle
    {
      public:
        explicit RkAiqAcnrV2HandleInt(RkAiqAlgoDesComm* des, RkAiqCore* aiqCore) : RkAiqHandle(des, aiqCore)
        {
