 ...
 */
#ifndef _RK_AIQ_ASD_HANDLE_INT_H_
#define _RK_AIQ_ASD_HANDLE_INT_H_
...
namespace RkCam
{
    ...
    {
      public:
        explicit RkAiqAsdHandleInt(RkAiqAlgoDesComm* des, RkAiqCore* aiqCore) : RkAiqHandle(des, aiqCore)
        {
        }
