 ...
 */
#ifndef _RK_AIQ_CNR_HANDLE_INT_H_
#define _RK_AIQ_CNR_HANDLE_INT_H_
...
namespace RkCam
{
    ...
    {
      public:
        explicit RkAiqAcnrHandleInt(RkAiqAlgoDesComm* des, RkAiqCore* aiqCore) : RkAiqHandle(des, aiqCore)
        {
