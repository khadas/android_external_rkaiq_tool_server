...
namespace RkCam
{
    ...
    {
      public:
        explicit RkAiqCamgroupHandle(RkAiqAlgoDesComm* des, RkAiqCamGroupManager* camGroupMg);
        ...
        void setNextHdl(RkAiqCamgroupHandle* next)
        {
            mNextHdl = next;
        }
        void setParentHdl(RkAiqCamgroupHandle* parent)
        {
            mParentHdl = parent;
        }
        RkAiqCamgroupHandle* getNextHdl()
        {
            return mNextHdl;
        }
        RkAiqCamgroupHandle* getParent()
        {
            return mParentHdl;
        }
