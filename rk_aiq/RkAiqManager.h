...
namespace RkCam
{
    ...
    class RkAiqMngCmdThread : public Thread
    {
      public:
        RkAiqMngCmdThread(RkAiqManager* aiqMng) : Thread("RkAiqMngCmdThread"), mAiqMng(aiqMng){};
        ~RkAiqMngCmdThread(){};
    ...
    class RkAiqRstApplyThread : public Thread
    {
      public:
        RkAiqRstApplyThread(RkAiqManager* aiqMng) : Thread("RkAiqRstApplyThread"), mAiqMng(aiqMng){};
        ~RkAiqRstApplyThread(){};
    ...
    class RkAiqManager : /* public IspStatsListener
...
#endif
      public:
        explicit RkAiqManager(const char* sns_ent_name, rk_aiq_error_cb err_cb, rk_aiq_metas_cb metas_cb);
