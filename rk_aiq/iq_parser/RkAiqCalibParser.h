...
namespace RkCam
{
    ...
    class RkAiqCalibParser
    {
      private:
        ...
        bool parseEntryCell(const XMLElement*, int, parseCellContent, void* param = NULL, uint32_t cur_id = 0,
                            uint32_t parent_id = 0);
        bool parseEntryCell2(const XMLElement*, int, parseCellContent2, void* param = NULL, uint32_t cur_id = 0,
                             uint32_t parent_id = 0);
        bool parseEntryCell3(XMLElement*, int, int, parseCellContent, void* param = NULL, uint32_t cur_id = 0,
                             uint32_t parent_id = 0);
        bool parseEntryCell4(XMLElement*, int, int, parseCellContent2, void* param = NULL, uint32_t cur_id = 0,
                             uint32_t parent_id = 0);
        ...
        bool parseEntrySensorBayernrV2(const XMLElement* pelement, void* param = NULL);

        bool parseEntryBayernrV2Setting_2D(const XMLElement* pelement, void* param, int index);

        bool parseEntryBayernrV2Setting_3D(const XMLElement* pelement, void* param, int index);

        bool parseEntrySensorBayernrV2Setting2D(const XMLElement* pelement, void* param);

        bool parseEntrySensorBayernrV2Setting3D(const XMLElement* pelement, void* param);
        bool parseEntrySensorYnrV2(const XMLElement* pelement, void* param);
        bool parseEntryYnrV2Setting(const XMLElement* pelement, void* param, int index);
        bool parseEntrySensorCnrV1(const XMLElement* pelement, void* param);
        bool parseEntryCnrV1Setting(const XMLElement* pelement, void* param, int index);
        bool parseEntrySharpV3Setting(const XMLElement* pelement, void* param, int index);
        bool parseEntrySensorSharpV3(const XMLElement* pelement, void* param);
