...
int calib_check_tag_attrs(CALIB_IQ_TAG_ID_T tag_id, uint32_t type, int size, CALIB_IQ_TAG_ID_T parent_tag_id);
...
#define XML_CHECK_SET_CUR_ID(cur_id) cur_tag_id = cur_id;
...
#define XML_CHECK_MARK_IF_NEED(type, size)                                                                             \
    calib_tag_info_t* tag_info = cur_tag_id < CALIB_IQ_TAG_END ? &(g_calib_tag_infos[cur_tag_id]) : NULL;              \
...
#define XML_CHECK_END() calib_check_nonleaf_tag_end(parent_tag_id);

#define XML_CHECK_CELL_SET_SIZE(size) calib_check_cell_set_size(cur_tag_id, parent_tag_id, size);

#define XML_CHECK_GET_TAG_ID(tag_name) calib_check_getID_by_name(tag_name, parent_tag_id, &cur_tag_id);

#define XML_CHECK_TAGID_COMPARE(tag_id) cur_tag_id == tag_id
