...
#define POLL_STOP_RET 3
    ...
    class V4l2Device
    {
      ...
      public:
        ...
        XCamReturn set_format(uint32_t width, uint32_t height, uint32_t pixelformat,
      ...
      protected:
        ...
        virtual XCamReturn allocate_buffer(SmartPtr<V4l2Buffer>& buf, const struct v4l2_format& format,
