...
namespace XCam
{
    ...
    class PollThread
    {
      ...
      public:
        ...
        bool set_isp_params_devices(SmartPtr<V4l2Device>& params_dev, SmartPtr<V4l2Device>& post_params_dev);
      ...
      protected:
        ...
        virtual SmartPtr<VideoBuffer> new_video_buffer(SmartPtr<V4l2Buffer> buf, SmartPtr<V4l2Device> dev, int type);
