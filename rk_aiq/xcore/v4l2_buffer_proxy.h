...
namespace XCam
{
    ...
    class V4l2Buffer : public BufferData
    {
      public:
    ...
    class V4l2BufferProxy : public BufferProxy
    {
      public:
      ...
      private:
        ...
        void v4l2_format_to_video_info(const struct v4l2_format& format, VideoBufferInfo& info);
