...
typedef enum
{
    ...
    XCORE_LOG_MODULE_ACAC,
    XCORE_LOG_MODULE_CAMGROUP,
    XCORE_LOG_MODULE_AWBGROUP,
    XCORE_LOG_MODULE_GROUPAEC,
...
#define LOGD_AWBGROUP_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_DEBUG(XCORE_LOG_MODULE_AWBGROUP, sub_modules, ##__VA_ARGS__)
#define LOGE_AWBGROUP_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_ERROR(XCORE_LOG_MODULE_AWBGROUP, sub_modules, ##__VA_ARGS__)
#define LOGW_AWBGROUP_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_WARNING(XCORE_LOG_MODULE_AWBGROUP, sub_modules, ##__VA_ARGS__)
#define LOGV_AWBGROUP_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_VERBOSE(XCORE_LOG_MODULE_AWBGROUP, sub_modules, ##__VA_ARGS__)
...
#define LOGV_AMERGE(...)                                                                                               \
    XCAM_MODULE_LOG_VERBOSE(XCORE_LOG_MODULE_AMERGE, 0xff, ##__VA_ARGS__) // AMERGE expo register data
...
#define LOGD_ANALYZER_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_DEBUG(XCORE_LOG_MODULE_ANALYZER, sub_modules, ##__VA_ARGS__)
#define LOGE_ANALYZER_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_ERROR(XCORE_LOG_MODULE_ANALYZER, sub_modules, ##__VA_ARGS__)
#define LOGW_ANALYZER_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_WARNING(XCORE_LOG_MODULE_ANALYZER, sub_modules, ##__VA_ARGS__)
#define LOGV_ANALYZER_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_VERBOSE(XCORE_LOG_MODULE_ANALYZER, sub_modules, ##__VA_ARGS__)
...
#define LOGD_CAMGROUP_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_DEBUG(XCORE_LOG_MODULE_CAMGROUP, sub_modules, ##__VA_ARGS__)
#define LOGE_CAMGROUP_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_ERROR(XCORE_LOG_MODULE_CAMGROUP, sub_modules, ##__VA_ARGS__)
#define LOGW_CAMGROUP_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_WARNING(XCORE_LOG_MODULE_CAMGROUP, sub_modules, ##__VA_ARGS__)
#define LOGV_CAMGROUP_SUBM(sub_modules, ...)                                                                           \
    XCAM_MODULE_LOG_VERBOSE(XCORE_LOG_MODULE_CAMGROUP, sub_modules, ##__VA_ARGS__)
...
#define NULL_RETURN_RET(ptr, ret)                                                                                      \
    do {                                                                                                               \
        if (ptr == NULL) {                                                                                             \
            LOGE("%s is NULL!\n", #ptr);                                                                               \
            return ret;                                                                                                \
