...
#define SMTBUF_NAME_STR_LEN (32)
    ...
    typedef void (*SmartBufferCbNotify_t)(void* pUserContext, XCamVideoBuffer* pVideoBuffer);

    class SmartBufferPriv : public XCamVideoBufferRK
    {
      public:
        ...
        SmartPtr<VideoBuffer> get_video_buffer()
        {
            return _buf_ptr;
        }
    ...
    XCamVideoBuffer* convert_to_XCamVideoBuffer(const SmartPtr<VideoBuffer>& buf);
