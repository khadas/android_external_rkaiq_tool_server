...
XCamReturn rk_aiq_uapi_ae_setExpSwAttr(RkAiqAlgoContext* ctx, const Uapi_ExpSwAttrV2_t* pExpSwAttr, bool isGroupAe,
                                       bool need_sync);
XCamReturn rk_aiq_uapi_ae_getExpSwAttr(RkAiqAlgoContext* ctx, Uapi_ExpSwAttrV2_t* pExpSwAttr, bool isGroupAe);
XCamReturn rk_aiq_uapi_ae_setLinExpAttr(RkAiqAlgoContext* ctx, const Uapi_LinExpAttrV2_t* pLinExpAttr, bool isGroupAe,
                                        bool need_sync);
XCamReturn rk_aiq_uapi_ae_getLinExpAttr(RkAiqAlgoContext* ctx, Uapi_LinExpAttrV2_t* pLinExpAttr, bool isGroupAe);
XCamReturn rk_aiq_uapi_ae_setHdrExpAttr(RkAiqAlgoContext* ctx, const Uapi_HdrExpAttrV2_t* pHdrExpAttr, bool isGroupAe,
                                        bool need_sync);
XCamReturn rk_aiq_uapi_ae_getHdrExpAttr(RkAiqAlgoContext* ctx, Uapi_HdrExpAttrV2_t* pHdrExpAttr, bool isGroupAe);

XCamReturn rk_aiq_uapi_ae_setLinAeRouteAttr(RkAiqAlgoContext* ctx, const Uapi_LinAeRouteAttr_t* pLinAeRouteAttr,
                                            bool isGroupAe, bool need_sync);
XCamReturn rk_aiq_uapi_ae_getLinAeRouteAttr(RkAiqAlgoContext* ctx, Uapi_LinAeRouteAttr_t* pLinAeRouteAttr,
                                            bool isGroupAe);
XCamReturn rk_aiq_uapi_ae_setHdrAeRouteAttr(RkAiqAlgoContext* ctx, const Uapi_HdrAeRouteAttr_t* pHdrAeRouteAttr,
                                            bool isGroupAe, bool need_sync);
XCamReturn rk_aiq_uapi_ae_getHdrAeRouteAttr(RkAiqAlgoContext* ctx, Uapi_HdrAeRouteAttr_t* pHdrAeRouteAttr,
                                            bool isGroupAe);

XCamReturn rk_aiq_uapi_ae_setSyncTest(RkAiqAlgoContext* ctx, const Uapi_AecSyncTest_t* pAecSyncTestAttr, bool isGroupAe,
                                      bool need_sync);
