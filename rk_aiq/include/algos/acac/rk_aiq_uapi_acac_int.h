...
XCamReturn rk_aiq_uapi_acac_SetAttrib(RkAiqAlgoContext* ctx, rk_aiq_cac_attrib_t attr, bool need_sync);
XCamReturn rk_aiq_uapi_acac_GetAttrib(const RkAiqAlgoContext* ctx, rk_aiq_cac_attrib_t* attr);
XCamReturn rk_aiq_uapi_acac_QueryCacInfo(const RkAiqAlgoContext* ctx, rk_aiq_cac_querry_info_t* cac_querry_info);
