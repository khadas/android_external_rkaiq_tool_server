...
XCamReturn rk_aiq_uapi_aeis_SetAttrib(RkAiqAlgoContext* ctx, rk_aiq_eis_attrib_t attr, bool need_sync);
XCamReturn rk_aiq_uapi_aeis_GetAttrib(const RkAiqAlgoContext* ctx, rk_aiq_eis_attrib_t* attr);
XCamReturn rk_aiq_uapi_aeis_QueryEisInfo(const RkAiqAlgoContext* ctx, rk_aiq_eis_querry_info_t* eis_querry_info);
