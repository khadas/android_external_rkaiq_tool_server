...
XCamReturn rk_aiq_uapi_adegamma_SetAttrib(RkAiqAlgoContext* ctx, rk_aiq_degamma_attrib_t attr, bool need_sync);
XCamReturn rk_aiq_uapi_adegamma_GetAttrib(const RkAiqAlgoContext* ctx, rk_aiq_degamma_attrib_t* attr);
