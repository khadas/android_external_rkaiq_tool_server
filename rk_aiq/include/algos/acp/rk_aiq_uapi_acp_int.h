...
XCamReturn rk_aiq_uapi_acp_SetAttrib(RkAiqAlgoContext* ctx, acp_attrib_t attr, bool need_sync);

XCamReturn rk_aiq_uapi_acp_GetAttrib(RkAiqAlgoContext* ctx, acp_attrib_t* attr);
