...
XCamReturn rk_aiq_uapi_atmo_SetAttrib(RkAiqAlgoContext* ctx, atmo_attrib_t attr, bool need_sync);

XCamReturn rk_aiq_uapi_atmo_GetAttrib(RkAiqAlgoContext* ctx, atmo_attrib_t* attr);
