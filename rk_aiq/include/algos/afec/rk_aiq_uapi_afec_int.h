...
XCamReturn rk_aiq_uapi_afec_SetAttrib(RkAiqAlgoContext* ctx, rk_aiq_fec_attrib_t attr, bool need_sync);
XCamReturn rk_aiq_uapi_afec_GetAttrib(const RkAiqAlgoContext* ctx, rk_aiq_fec_attrib_t* attr);
