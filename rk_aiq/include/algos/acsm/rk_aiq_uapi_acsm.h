...
XCamReturn rk_aiq_uapi_acsm_SetAttrib(RkAiqAlgoContext* ctx, rk_aiq_uapi_acsm_attrib_t attr);

XCamReturn rk_aiq_uapi_acsm_GetAttrib(RkAiqAlgoContext* ctx, rk_aiq_uapi_acsm_attrib_t* attr);
