...
XCamReturn rk_aiq_uapi_aie_SetAttrib(RkAiqAlgoContext* ctx, aie_attrib_t attr, bool need_sync);

XCamReturn rk_aiq_uapi_aie_GetAttrib(RkAiqAlgoContext* ctx, aie_attrib_t* attr);
