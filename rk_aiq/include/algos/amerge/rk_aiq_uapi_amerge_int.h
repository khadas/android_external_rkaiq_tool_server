...
XCamReturn rk_aiq_uapi_amerge_SetAttrib(RkAiqAlgoContext* ctx, amerge_attrib_t attr, bool need_sync);

XCamReturn rk_aiq_uapi_amerge_GetAttrib(RkAiqAlgoContext* ctx, amerge_attrib_t* attr);
