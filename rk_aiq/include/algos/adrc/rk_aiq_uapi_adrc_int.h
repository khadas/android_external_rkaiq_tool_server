...
XCamReturn rk_aiq_uapi_adrc_SetAttrib(RkAiqAlgoContext* ctx, drc_attrib_t attr, bool need_sync);

XCamReturn rk_aiq_uapi_adrc_GetAttrib(RkAiqAlgoContext* ctx, drc_attrib_t* attr);
