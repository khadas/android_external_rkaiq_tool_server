...
#define XCAM_CLAMP(v, min, max) (((v) < (min)) ? (min) : (((v) > (max)) ? (max) : (v)))
...
#define XCAM_DOUBLE_EQUAL(a, b, tolerance) (((a) >= ((b) - (tolerance))) && ((a) <= ((b) + (tolerance))))

#define XCAM_DOUBLE_EQUAL_AROUND(a, b) XCAM_DOUBLE_EQUAL((a), (b), 0.000001)
...
#define XCAM_TIMESTAMP_ARGS(t)                                                                                         \
    (int32_t)(XCAM_TIMESTAMP_2_SECONDS(t) / 3600), (int32_t)((XCAM_TIMESTAMP_2_SECONDS(t) % 3600) / 60),               \
        (int32_t)(XCAM_TIMESTAMP_2_SECONDS(t) % 60), (int32_t)(((t) / 1000) % 1000)
