...
#if 0
    #define RKAIQ_CALIB_GET_HW_VER(ctx) ((CalibDb_Header_t*)(ctx))->isp_hw_version
#endif

#define TO_CALIBDBV1_ISP20(ctx) ((CamCalibDbContextIsp20_t*)ctx)

#define TO_CALIBDBV1_ISP21(ctx) ((CamCalibDbContextIsp21_t*)ctx)

#define CALIB_MODULE_RELATIVE_OFFSET(type, x) (long)(&((type*)0)->x)

#define CALIB_MODULE_PTR(ctx, type, mn) ((char*)(ctx) + CALIB_MODULE_RELATIVE_OFFSET(type, mn))
...
#define CALIB_MODULE_RELATIVE_OFFSET_ISP20(nm) CALIB_MODULE_RELATIVE_OFFSET(CamCalibDbContextIsp20_t, nm)
...
#define CALIB_MODULE_RELATIVE_OFFSET_ISP21(nm) CALIB_MODULE_RELATIVE_OFFSET(CamCalibDbContextIsp21_t, nm)
...
static inline void* calibdb_get_module_ptr(void* ctx, calibdb_ctx_infos_t* info_array, const char* module_name)
{
...
#define CALIBDB_GET_MODULE_PTR(ctx, module) calibdb_get_module_ptr(ctx, info_CamCalibDbContext_array, #module)
