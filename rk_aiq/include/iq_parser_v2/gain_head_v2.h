...
typedef struct CalibDbV2_GainV2_TuningPara_Setting_ISO_s {
...
} CalibDbV2_GainV2_TuningPara_Setting_ISO_t;

typedef struct CalibDbV2_GainV2_TuningPara_Setting_s {
    ...
    CalibDbV2_GainV2_TuningPara_Setting_ISO_t* Tuning_ISO;
    int Tuning_ISO_len;
} CalibDbV2_GainV2_TuningPara_Setting_t;

typedef struct CalibDbV2_GainV2_TuningPara_s {
    // M4_BOOL_DESC("hdrgain_ctrl_enable", "1")
    bool hdrgain_ctrl_enable;
    // M4_STRUCT_LIST_DESC("Setting", M4_SIZE_DYNAMIC, "double_index_list")
    CalibDbV2_GainV2_TuningPara_Setting_t* Setting;
    int Setting_len;
} CalibDbV2_GainV2_TuningPara_t;
...
typedef struct CalibDbV2_GainV2_s {
    ...
    CalibDbV2_GainV2_TuningPara_t TuningPara;
} CalibDbV2_GainV2_t;
