...
typedef struct CalibDbV2_SharpV4_TuningPara_Setting_ISO_kernel_s {
    ...
    // M4_ARRAY_DESC("GaussianFilter_coeff", "f32", M4_SIZE(1,6), M4_RANGE(0,1), "[0.2042,0.1238,0.0751]", M4_DIGIT(4),
    // M4_DYNAMIC(0))
...
typedef struct CalibDbV2_SharpV4_TuningPara_Setting_ISO_kernel_sigma_s {
    ...
    // M4_ARRAY_DESC("hfBilateralFilter_sigma", "f32", M4_SIZE(1,1), M4_RANGE(0,100), "[1.0]", M4_DIGIT(2),
    // M4_DYNAMIC(0))
