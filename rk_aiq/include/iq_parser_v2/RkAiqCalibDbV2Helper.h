...
#define CALIBV2_MODULE_RELATIVE_OFFSET_ISP20(nm) CALIB_MODULE_RELATIVE_OFFSET(CamCalibDbV2ContextIsp20_t, nm)
...
#define CALIBV2_MODULE_RELATIVE_OFFSET_ISP21(nm) CALIB_MODULE_RELATIVE_OFFSET(CamCalibDbV2ContextIsp21_t, nm)
...
#define CALIBV2_MODULE_RELATIVE_OFFSET_ISP30(nm) CALIB_MODULE_RELATIVE_OFFSET(CamCalibDbV2ContextIsp30_t, nm)
...
static inline void* calibdbv2_get_scene_ptr(CamCalibSubSceneList_t* scene)
{
    (void)(scene);
...
static inline void* calibdbV2_get_module_ptr(void* ctx, calibdb_ctx_infos_t* info_array, const char* module_name)
{
...
static inline int calibdbV2_to_tuningdb(CamCalibDbV2Tuning_t* dst, const CamCalibDbV2Context_t* src)
{
    ...
    memcpy(&dst->sys_static_cfg, src->sys_cfg, sizeof(CalibDb_SysStaticCfg_ParaV2_t));
#if defined(ISP_HW_V20)
    memcpy(&dst->calib_scene, src->calib_scene, sizeof(CamCalibDbV2ContextIsp20_t));
#elif defined(ISP_HW_V21)
    memcpy(&dst->calib_scene, src->calib_scene, sizeof(CamCalibDbV2ContextIsp21_t));
#elif defined(ISP_HW_V30)
    memcpy(&dst->calib_scene, src->calib_scene, sizeof(CamCalibDbV2ContextIsp30_t));
#else
...
static inline int calibdbV2_from_tuningdb(CamCalibDbV2Context_t* dst, const CamCalibDbV2Tuning_t* src)
{
    ...
    memcpy(dst->sys_cfg, &src->sys_static_cfg, sizeof(CalibDb_SysStaticCfg_ParaV2_t));
#if defined(ISP_HW_V20)
    memcpy(dst->calib_scene, &src->calib_scene, sizeof(CamCalibDbV2ContextIsp20_t));
#elif defined(ISP_HW_V21)
    memcpy(dst->calib_scene, &src->calib_scene, sizeof(CamCalibDbV2ContextIsp21_t));
...
#define CALIBDBV2_GET_MODULE_PTR(ctx, module) calibdbV2_get_module_ptr(ctx, info_CamCalibDbV2Context_array, #module)
#endif
