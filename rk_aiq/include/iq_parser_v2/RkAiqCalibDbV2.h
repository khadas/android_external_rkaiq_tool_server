...
namespace RkCam
{
    ...
    class RkAiqCalibDbV2
    {
      ...
      public:
        ...
        static cJSON* readIQNode(const CamCalibDbV2Context_t* calib, const char* node_path);

        static char* readIQNodeStr(const CamCalibDbV2Context_t* calib, const char* node_path);

        static char* readIQNodeStrFromJstr(const CamCalibDbV2Context_t* calib, const char* json_str);

        static CamCalibDbV2Context_t* applyPatch(const CamCalibDbV2Context_t* calib, cJSON* patch);
        static CamCalibDbV2Context_t* applyPatch2(const CamCalibDbV2Context_t* calib, cJSON* patch);

        static CamCalibDbV2Context_t* applyPatch(const CamCalibDbV2Context_t* calib, const char* patch_str);
        static CamCalibDbV2Context_t* applyPatchFile(const CamCalibDbV2Context_t* calib, const char* patch_file);
        static CamCalibDbV2Context_t* applyPatch(const char* jsfile, const char* patch_file);

        static TuningCalib analyzTuningCalib(const CamCalibDbV2Context_t* calib, cJSON* patch);
        static TuningCalib analyzTuningCalib(const CamCalibDbV2Context_t* calib, const char* patch_str);
