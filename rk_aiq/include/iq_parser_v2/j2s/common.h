...
//#define DEBUG
    ...
    #define MSG(level, fmt, args...)                                                                                   \
        fprintf(stderr, #level ": %s(%d) [%s]: " fmt, __FILE__, __LINE__, __FUNCTION__, ##args)
#endif
...
#define J2S_IS_ARRAY(obj) ((obj)->flags & J2S_FLAG_ARRAY && !((obj)->flags & J2S_FLAG_ARRAY_POINTER))

#define J2S_IS_POINTER(obj) ((obj)->flags & J2S_FLAG_POINTER && !J2S_IS_ARRAY(obj))
