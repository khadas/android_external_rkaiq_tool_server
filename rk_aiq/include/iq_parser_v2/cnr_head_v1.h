...
///////////////////////////uvnr//////////////////////////////////////
typedef struct CalibDbV2_CNR_TuningPara_Setting_ISO_s {
...
} CalibDbV2_CNR_TuningPara_Setting_ISO_t;

typedef struct CalibDbV2_CNR_TuningPara_Setting_s {
    ...
    CalibDbV2_CNR_TuningPara_Setting_ISO_t* Tuning_ISO;
    int Tuning_ISO_len;

} CalibDbV2_CNR_TuningPara_Setting_t;

typedef struct CalibDbV2_CNR_TuningPara_Kernel_s {
    // M4_ARRAY_DESC("kernel_5x5", "f32", M4_SIZE(1,5), M4_RANGE(0,1), "[1.0000,0.8825,0.7788,0.6065,0.3679]",
    // M4_DIGIT(6), M4_DYNAMIC(0))
    float kernel_5x5[5];
} CalibDbV2_CNR_TuningPara_Kernel_t;

typedef struct CalibDbV2_CNR_TuningPara_s {
    // M4_BOOL_DESC("enable", "1")
    int enable;
    // M4_STRUCT_DESC("Kernel_Coeff", "normal_ui_style")
    CalibDbV2_CNR_TuningPara_Kernel_t Kernel_Coeff;
    // M4_STRUCT_LIST_DESC("Setting", M4_SIZE_DYNAMIC, "double_index_list")
    CalibDbV2_CNR_TuningPara_Setting_t* Setting;
    int Setting_len;
} CalibDbV2_CNR_TuningPara_t;
...
typedef struct CalibDbV2_CNR_s {
    ...
    CalibDbV2_CNR_TuningPara_t TuningPara;
} CalibDbV2_CNR_t;
