...
typedef struct rk_tool_awb_stat_wp_res_v201_s {
    ...
    long long WpNo;
    // M4_NUMBER_DESC("RgainValue", "s64", M4_RANGE(-9223372036854775808,9223372036854775807), "0", M4_DIGIT(0),
    // M4_HIDE(0))
    long long RgainValue;
    // M4_NUMBER_DESC("BgainValue", "s64", M4_RANGE(-9223372036854775808,9223372036854775807), "0", M4_DIGIT(0),
    // M4_HIDE(0))
...
typedef struct rk_tool_awb_measure_wp_res_fl_s {
    ...
    // M4_ARRAY_DESC("WpNoHist_2", "s32", M4_SIZE(1,8), M4_RANGE(-2147483648,2147483647), "0", M4_DIGIT(0),
    // M4_DYNAMIC(0))
...
typedef struct rk_tool_awb_effect_para1_s {
    // M4_ARRAY_DESC("hdrFrameChoose", "s32", M4_SIZE(1,1), M4_RANGE(-2147483648,2147483647), "0", M4_DIGIT(0),
    // M4_DYNAMIC(0))
    int hdrFrameChoose;
...
typedef struct rk_tool_awb_strategy_result_s {
    ...
    rk_tool_awb_illInf_t
        illInf[RK_TOOL_AWB_MAX_WHITEREGIONS_NUM2]; // information and measure result in different illuminations
