...
#ifndef __CALIBDBV2_CNRV2_HEADER_H__
#define __CALIBDBV2_CNRV2_HEADER_H__
...
typedef struct CalibDbV2_CNRV2_TuningPara_Setting_ISO_s {
    ...
    // M4_ARRAY_DESC("gain_adj_strength_ratio", "f32", M4_SIZE(1,13), M4_RANGE(0,255), "1.0", M4_DIGIT(2),
    // M4_DYNAMIC(0))
