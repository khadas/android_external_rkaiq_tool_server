...
typedef struct CalibDbV2_Ldch_Param_s {
    ...
    // M4_ARRAY_DESC("light_center", "f64", M4_SIZE(1,2), M4_RANGE(-10000000000000000,10000000000000000), "0",
    // M4_DIGIT(8), M4_DYNAMIC(0))
    double light_center[2]; // light center
    // M4_ARRAY_DESC("coefficient", "f64", M4_SIZE(1,4), M4_RANGE(-10000000000000000,10000000000000000), "0",
    // M4_DIGIT(8), M4_DYNAMIC(0))
