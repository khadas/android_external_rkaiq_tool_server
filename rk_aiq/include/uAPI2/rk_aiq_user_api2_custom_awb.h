 ...
 */
XCamReturn rk_aiq_uapi2_customAWB_register(const rk_aiq_sys_ctx_t* ctx, rk_aiq_customeAwb_cbs_t* cbs);
 ...
 */
XCamReturn rk_aiq_uapi2_customAWB_enable(const rk_aiq_sys_ctx_t* ctx, bool enable);
 ...
 */
XCamReturn rk_aiq_uapi2_customAWB_unRegister(const rk_aiq_sys_ctx_t* ctx);
