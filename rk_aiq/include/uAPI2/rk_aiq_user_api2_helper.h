...
#define __RKAIQUAPI_CALLER(type_name)                                                                                  \
    inline int __rkaiq_uapi_##type_name##_call(void* desc, void* sys_ctx, cJSON* cmd_js, cJSON** ret_js, int mode)     \
    {                                                                                                                  \
        ...
        if (mode == RKAIQUAPI_OPMODE_SET) {                                                                            \
            ...
            cJSON* old_json = NULL;                                                                                    \
            ret = __rkaiq_uapi_##type_name##_call(desc, sys_ctx, cmd_js, &old_json, RKAIQUAPI_OPMODE_GET);             \
            if (ret || !old_json) {                                                                                    \
...
typedef struct __RkAiqUapiDesc {
    ...
    #define __RKAIQUAPI_DESC_DEF(__arg_path, __arg_type, __arg_set, __arg_get)                                         \
        {                                                                                                              \
            .arg_path = {__arg_path}, .arg_type = {#__arg_type}, .arg_set = (RkAiqUapi)__arg_set,                      \
            .arg_get = (RkAiqUapi)__arg_get, .uapi_caller = (RkAiqUapiCaller)__rkaiq_uapi_##__arg_type##_call,         \
        }
...
int rkaiq_uapi_unified_ctl(rk_aiq_sys_ctx_t* sys_ctx, const char* js_str, char** ret_str, int op_mode);
