...
namespace RkCam
{
    ...
    class RkAiqCamGroupReprocTh : public Thread
    {
      public:
        RkAiqCamGroupReprocTh(RkAiqCamGroupManager* camGroupManager)
            : Thread("RkAiqCamGroupReprocTh"), mCamGroupManager(camGroupManager){};
        ...
        typedef struct rk_aiq_groupcam_result_wrapper_s {
            rk_aiq_groupcam_result_wrapper_s(rk_aiq_groupcam_result_t* gc_result) : _gc_result(gc_result){};
