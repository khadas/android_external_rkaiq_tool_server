...
typedef enum CalibDbV2_CamGroup_Abayernr_Method_e
{
    ...
    CalibDbV2_CAMGROUP_ABAYERNR_METHOD_MEAN, /*config each camera with same para, para is got by mean stas of all
                                                cameras*/
    CalibDbV2_CAMGROUP_ABAYERNR_METHOD_MAX,  /*config each camera with diff para, each para is got by stats of tha
                                                camera*/
