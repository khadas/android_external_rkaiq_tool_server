...
RKIIO_BUFFER_CELL rkiio_buffer_list_copy(RKIIO_BUFFER rkiio_buf, RK_U64* cell_id_mark, RK_U64* copy_num,
                                         RK_U64 max_copy_num);
RK_S32 rkiio_buffer_cell_release(RKIIO_BUFFER_CELL ib_list);

RK_S32 _rkiio_buffer_list_full_copy(RKIIO_BUFFER rkiio_buf, RKIIO_BUFFER_CELL ib_list, RK_U64* cell_id_mark,
                                    RK_U64* copy_num);
RK_S32 _rkiio_buffer_list_copy(RKIIO_BUFFER rkiio_buf, RKIIO_BUFFER_CELL ib_list, RK_U64* cell_id_mark,
                               RK_U64* copy_num, RK_U64 max_copy_num);
