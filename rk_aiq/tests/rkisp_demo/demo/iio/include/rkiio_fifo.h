...
RKIIO_FIFO_HANDLE rkiio_fifo_handle_create(RKIIO_FIFO_DEV dev, RK_S32 last_index, struct rkiio_format_info* format_info,
                                           RK_U8 info_num, RK_U32 buf_max_num, double max_sampling_rate);
...
RK_S32 rkiio_fifo_data_read_all(RKIIO_FIFO_HANDLE fifo_handle, RKIIO_FIFO_DATA fifo_data, RK_U64* frame_id,
                                RK_U64* data_num);
RK_S32 rkiio_fifo_data_read_num(RKIIO_FIFO_HANDLE fifo_handle, RKIIO_FIFO_DATA fifo_data, RK_U64* frame_id,
                                RK_U64 data_num);
