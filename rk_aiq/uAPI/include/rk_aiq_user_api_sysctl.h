 ...
 *       exsist.
 */
XCamReturn rk_aiq_uapi_sysctl_preInit(const char* sns_ent_name, rk_aiq_working_mode_t mode, const char* force_iq_file);
 ...
 */
XCamReturn rk_aiq_uapi_sysctl_preInit_scene(const char* sns_ent_name, const char* main_scene, const char* sub_scene);
 ...
 */
rk_aiq_sys_ctx_t* rk_aiq_uapi_sysctl_init(const char* sns_ent_name, const char* iq_file_dir, rk_aiq_error_cb err_cb,
 ...
 */
void rk_aiq_uapi_sysctl_deinit(rk_aiq_sys_ctx_t* ctx);
 ...
 */
XCamReturn rk_aiq_uapi_sysctl_prepare(const rk_aiq_sys_ctx_t* ctx, uint32_t width, uint32_t height,
 ...
 * \return return 0 if success
 */
XCamReturn rk_aiq_uapi_sysctl_start(const rk_aiq_sys_ctx_t* ctx);
 ...
 * \return return 0 if success
 */
XCamReturn rk_aiq_uapi_sysctl_stop(const rk_aiq_sys_ctx_t* ctx, bool keep_ext_hw_st);

XCamReturn rk_aiq_uapi_sysctl_getStaticMetas(const char* sns_ent_name, rk_aiq_static_info_t* static_info);
 ...
 * \return return 0 if success
 */
XCamReturn rk_aiq_uapi_sysctl_enumStaticMetas(int index, rk_aiq_static_info_t* static_info);
...
XCamReturn rk_aiq_uapi_sysctl_getMetaData(const rk_aiq_sys_ctx_t* ctx, uint32_t frame_id, rk_aiq_metas_t* metas);
...
XCamReturn rk_aiq_uapi_sysctl_setModuleCtl(const rk_aiq_sys_ctx_t* ctx, rk_aiq_module_id_t mId, bool mod_en);

int32_t rk_aiq_uapi_sysctl_getModuleCtl(const rk_aiq_sys_ctx_t* ctx, rk_aiq_module_id_t mId, bool* mod_en);
 ...
 * \return return 0 if success
 */
XCamReturn rk_aiq_uapi_sysctl_enableAxlib(const rk_aiq_sys_ctx_t* ctx, const int algo_type, const int lib_id,
                                          bool enable);
 ...
 */
bool rk_aiq_uapi_sysctl_getAxlibStatus(const rk_aiq_sys_ctx_t* ctx, const int algo_type, const int lib_id);
 ...
 */
RkAiqAlgoContext* rk_aiq_uapi_sysctl_getEnabledAxlibCtx(const rk_aiq_sys_ctx_t* ctx, const int algo_type);
 ...
 * \return return NULL if failed
 */
RkAiqAlgoContext* rk_aiq_uapi_sysctl_getAxlibCtx(const rk_aiq_sys_ctx_t* ctx, const int algo_type, const int lib_id);
 ...
 */
XCamReturn rk_aiq_uapi_sysctl_get3AStats(const rk_aiq_sys_ctx_t* ctx, rk_aiq_isp_stats_t* stats);
 ...
 */
XCamReturn rk_aiq_uapi_sysctl_get3AStatsBlk(const rk_aiq_sys_ctx_t* ctx, rk_aiq_isp_stats_t** stats, int timeout_ms);
 ...
 */
void rk_aiq_uapi_sysctl_release3AStatsRef(const rk_aiq_sys_ctx_t* ctx, rk_aiq_isp_stats_t* stats);
/*!
 ...
 * \return return 0 if success
 */
XCamReturn rk_aiq_uapi_sysctl_setCpsLtCfg(const rk_aiq_sys_ctx_t* ctx, rk_aiq_cpsl_cfg_t* cfg);
/*!
 ...
 * \return return 0 if success
 */
XCamReturn rk_aiq_uapi_sysctl_getCpsLtInfo(const rk_aiq_sys_ctx_t* ctx, rk_aiq_cpsl_info_t* info);
/*!
 ...
 * \return return 0 if success
 */
XCamReturn rk_aiq_uapi_sysctl_queryCpsLtCap(const rk_aiq_sys_ctx_t* ctx, rk_aiq_cpsl_cap_t* cap);
 ...
 * \return return 0 if success
 */
XCamReturn rk_aiq_uapi_sysctl_setSharpFbcRotation(const rk_aiq_sys_ctx_t* ctx, rk_aiq_rotation_t rot);
 ...
 */
void rk_aiq_uapi_sysctl_setMulCamConc(const rk_aiq_sys_ctx_t* ctx, bool cc);
 ...
 */
XCamReturn rk_aiq_uapi_sysctl_setCrop(const rk_aiq_sys_ctx_t* sys_ctx, rk_aiq_rect_t rect);
 ...
 */
XCamReturn rk_aiq_uapi_sysctl_getCrop(const rk_aiq_sys_ctx_t* sys_ctx, rk_aiq_rect_t* rect);
 ...
 */
XCamReturn rk_aiq_uapi_sysctl_updateIq(rk_aiq_sys_ctx_t* sys_ctx, char* iqfile);

XCamReturn rk_aiq_uapi_sysctl_tuning(const rk_aiq_sys_ctx_t* sys_ctx, char* param);
 ...
 */
XCamReturn rk_aiq_uapi_sysctl_regMemsSensorIntf(const rk_aiq_sys_ctx_t* sys_ctx, const rk_aiq_mems_sensor_intf_t* intf);
 ...
 * @return 0 if no error
 */
int rk_aiq_uapi_sysctl_switch_scene(const rk_aiq_sys_ctx_t* sys_ctx, const char* main_scene, const char* sub_scene);
