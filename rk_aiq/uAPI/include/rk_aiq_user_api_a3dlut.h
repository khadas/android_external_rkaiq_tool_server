...
XCamReturn rk_aiq_user_api_a3dlut_GetAttrib(const rk_aiq_sys_ctx_t* sys_ctx, rk_aiq_lut3d_attrib_t* attr);
XCamReturn rk_aiq_user_api_a3dlut_Query3dlutInfo(const rk_aiq_sys_ctx_t* sys_ctx,
