...
namespace RkMSG
{
    ...
    class MessageParser
    {
      ...
      private:
        ...
        RkAiqSocketPacket_t* findValidSection(uint8_t* buffer, int len, size_t* start_of, size_t* end_of);
        RkAiqSocketPacket* findValidSection2(uint8_t* buffer, int len, size_t* start_of, size_t* end_of);
    };
