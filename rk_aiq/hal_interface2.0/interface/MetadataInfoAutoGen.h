...
const metadata_value_t android_tonemap_mode_values[] = {
    {"CONTRAST_CURVE", ANDROID_TONEMAP_MODE_CONTRAST_CURVE}, {"FAST", ANDROID_TONEMAP_MODE_FAST},
    {"HIGH_QUALITY", ANDROID_TONEMAP_MODE_HIGH_QUALITY},     {"GAMMA_VALUE", ANDROID_TONEMAP_MODE_GAMMA_VALUE},
...
const metadata_tag_t android_static_tags_table[] = {
    // COLOR_CORRECTION
    {"colorCorrection.availableAberrationModes",
     ANDROID_COLOR_CORRECTION_AVAILABLE_ABERRATION_MODES,
     TYPE_BYTE,
     android_colorCorrection_aberrationMode_values,
     3,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    ...
    {"control.aeAvailableAntibandingModes",
     ...
     TYPE_BYTE,
     android_control_aeAntibandingMode_values,
     4,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    ...
    {"control.afAvailableModes",
     ...
     TYPE_BYTE,
     android_control_afMode_values,
     6,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    {"control.availableEffects",
     ANDROID_CONTROL_AVAILABLE_EFFECTS,
     TYPE_BYTE,
     android_control_effectMode_values,
     9,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    {"control.availableSceneModes",
     ANDROID_CONTROL_AVAILABLE_SCENE_MODES,
     TYPE_BYTE,
     android_control_sceneMode_values,
     20,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    {"control.availableVideoStabilizationModes",
     ...
     TYPE_BYTE,
     android_control_videoStabilizationMode_values,
     2,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    {"control.awbAvailableModes",
     ...
     TYPE_BYTE,
     android_control_awbMode_values,
     9,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    ...
    {"control.availableHighSpeedVideoConfigurations",
    ...
    {"control.aeLockAvailable",
     ...
     TYPE_BYTE,
     android_control_aeLockAvailable_values,
     2,
     false,
     {0, 0, 0},
     0},
    {"control.awbLockAvailable",
     ...
     TYPE_BYTE,
     android_control_awbLockAvailable_values,
     2,
     false,
     {0, 0, 0},
     0},
    {"control.availableModes",
     ANDROID_CONTROL_AVAILABLE_MODES,
     TYPE_BYTE,
     android_control_mode_values,
     4,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    ...
    {"flash.info.available",
     ...
     TYPE_BYTE,
     android_flash_info_available_values,
     2,
     false,
     {0, 0, 0},
     0},
    ...
    {"lens.info.availableApertures",
     ...
     {-1, 0, 0},
     0},
    {"lens.info.availableFilterDensities",
    ...
    {"lens.info.availableOpticalStabilization",
     ...
     TYPE_BYTE,
     android_lens_opticalStabilizationMode_values,
     2,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    {"lens.info.hyperfocalDistance",
    ...
    {"lens.info.focusDistanceCalibration",
     ANDROID_LENS_INFO_FOCUS_DISTANCE_CALIBRATION,
     TYPE_BYTE,
     android_lens_info_focusDistanceCalibration_values,
     3,
     false,
     {0, 0, 0},
     0},
    ...
    {"noiseReduction.availableNoiseReductionModes",
     ...
     TYPE_BYTE,
     android_noiseReduction_mode_values,
     5,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    ...
    {"request.maxNumReprocessStreams",
    ...
    {"request.availableCapabilities",
     ...
     TYPE_BYTE,
     android_request_availableCapabilities_values,
     10,
     true,
     {-1, 0, 0},
     0},
    ...
    {"request.availableCharacteristicsKeys",
     ...
     0},
    // SCALER
    {"scaler.availableFormats",
     ANDROID_SCALER_AVAILABLE_FORMATS,
     TYPE_INT32,
     android_scaler_availableFormats_values,
     7,
     true,
     {-1, 0, 0},
     IMAGE_FORMAT},
    {"scaler.availableJpegMinDurations",
    ...
    {"scaler.availableProcessedMinDurations",
     ...
     {-1, 0, 0},
     0},
    {"scaler.availableProcessedSizes",
     ...
     {-1, 2, 0},
     SIZE},
    {"scaler.availableRawMinDurations",
    ...
    {"scaler.availableInputOutputFormatsMap",
    ...
    {"scaler.availableStreamConfigurations",
     ...
     TYPE_INT32,
     android_scaler_availableStreamConfigurations_values,
     2,
     true,
     {-1, 4, 0},
     STREAM_CONFIGURATION},
    ...
    {"scaler.croppingType",
     ...
     TYPE_BYTE,
     android_scaler_croppingType_values,
     2,
     false,
     {0, 0, 0},
     0},
    ...
    {"sensor.availableTestPatternModes",
     ...
     TYPE_INT32,
     android_sensor_testPatternMode_values,
     6,
     true,
     {-1, 0, 0},
     0},
    ...
    {"sensor.info.sensitivityRange",
     ...
     {2, 0, 0},
     RANGE_INT},
    {"sensor.info.colorFilterArrangement",
     ANDROID_SENSOR_INFO_COLOR_FILTER_ARRANGEMENT,
     TYPE_BYTE,
     android_sensor_info_colorFilterArrangement_values,
     5,
     false,
     {0, 0, 0},
     0},
    ...
    {"sensor.info.timestampSource",
     ...
     TYPE_BYTE,
     android_sensor_info_timestampSource_values,
     2,
     false,
     {0, 0, 0},
     0},
    {"sensor.info.lensShadingApplied",
     ANDROID_SENSOR_INFO_LENS_SHADING_APPLIED,
     TYPE_BYTE,
     android_sensor_info_lensShadingApplied_values,
     2,
     false,
     {0, 0, 0},
     0},
    {"sensor.info.preCorrectionActiveArraySize",
    ...
    {"statistics.info.availableFaceDetectModes",
     ...
     TYPE_BYTE,
     android_statistics_faceDetectMode_values,
     3,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    {"statistics.info.histogramBucketCount",
    ...
    {"statistics.info.maxFaceCount",
     ...
     {0, 0, 0},
     0},
    {"statistics.info.maxHistogramCount",
     ...
     {0, 0, 0},
     0},
    {"statistics.info.maxSharpnessMapValue",
     ...
     {0, 0, 0},
     0},
    {"statistics.info.sharpnessMapSize",
     ...
     {2, 0, 0},
     SIZE},
    {"statistics.info.availableHotPixelMapModes",
     ANDROID_STATISTICS_INFO_AVAILABLE_HOT_PIXEL_MAP_MODES,
     TYPE_BYTE,
     android_statistics_hotPixelMapMode_values,
     2,
     true,
     {-1, 0, 0},
     BOOLEAN},
    {"statistics.info.availableLensShadingMapModes",
     ...
     TYPE_BYTE,
     android_statistics_lensShadingMapMode_values,
     2,
     true,
     {-1, 0, 0},
     ENUM_LIST},
    ...
    {"led.availableLeds",
     ...
     TYPE_BYTE,
     android_led_availableLeds_values,
     1,
     true,
     {-1, 0, 0},
     0},
    ...
    {"info.supportedHardwareLevel",
     ...
     TYPE_BYTE,
     android_info_supportedHardwareLevel_values,
     3,
     false,
     {0, 0, 0},
     0},
    ...
    {"depth.availableDepthStreamConfigurations",
     ANDROID_DEPTH_AVAILABLE_DEPTH_STREAM_CONFIGURATIONS,
     TYPE_INT32,
     android_depth_availableDepthStreamConfigurations_values,
     2,
     true,
     {-1, 4, 0},
     STREAM_CONFIGURATION},
    {"depth.availableDepthMinFrameDurations",
     ...
     {4, -1, 0},
     STREAM_CONFIGURATION_DURATION},
    {"depth.availableDepthStallDurations",
    ...
    {"depth.depthIsExclusive",
     ...
     TYPE_BYTE,
     android_depth_depthIsExclusive_values,
     2,
     false,
     {0, 0, 0},
     0},
