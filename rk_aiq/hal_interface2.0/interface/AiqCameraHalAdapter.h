...
// namespace RkCam {
class AiqCameraHalAdapter : public IMessageHandler
{
  private:
  ...
  public:
    ...
    void set_aiq_ctx(rk_aiq_sys_ctx_t* aiq_ctx)
    {
        _aiq_ctx = aiq_ctx;
    };
    ...
    void set_static_metadata(const camera_metadata_t* metas)
    {
        staticMeta = metas;
    };
    static CameraMetadata& get_static_metadata()
    {
        return staticMeta;
    };
    XCamReturn set_control_params(const int request_frame_id, const camera_metadata_t* metas);
    void setAiqInputParams(SmartPtr<AiqInputParams> inputParams)
    {
        _inputParams = inputParams;
    };
    SmartPtr<AiqInputParams> getAiqInputParams_simple()
    {
        return _inputParams;
    };
    ...
    bool set_sensor_mode_data(rk_aiq_exposure_sensor_descriptor* sensor_mode, bool first);
    ...
    void set_working_mode(rk_aiq_working_mode_t work_mode)
    {
