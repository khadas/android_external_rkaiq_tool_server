...
#define V4L2_TYPE_IS_VALID(type)                                                                                       \
    ((type) == V4L2_BUF_TYPE_VIDEO_CAPTURE || (type) == V4L2_BUF_TYPE_VIDEO_OUTPUT ||                                  \
...
#define V4L2_TYPE_IS_META(type) ((type) == V4L2_BUF_TYPE_META_OUTPUT || (type) == V4L2_BUF_TYPE_META_CAPTURE)
