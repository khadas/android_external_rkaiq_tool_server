 ...
 *    0      : success
 */
int rkisp_cl_rkaiq_init(void** cl_ctx, const char* tuning_file_path, const cl_result_callback_ops_t* callback_ops,
...
int rkisp_cl_prepare(void* cl_ctx, const struct rkisp_cl_prepare_params_s* prepare_params);
 ...
 *    0      : success
 */
int rkisp_cl_set_frame_params(const void* cl_ctx, const struct rkisp_cl_frame_metadata_s* frame_params);
