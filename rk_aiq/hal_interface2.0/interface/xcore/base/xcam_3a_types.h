...
#define XCAM_AF_MAX_FOCUS_WINDOW_COUNT 6

typedef enum
{
    FRAME_USE_PREVIEW,
    FRAME_USE_STILL,
    FRAME_USE_CONTINUOUS,
    FRAME_USE_VIDEO,
} XCamAfFrameUse;
...
typedef enum
{
    AF_RANGE_NORMAL,   /*!< Normal range */
    AF_RANGE_MACRO,    /*!< Macro range */
    AF_RANGE_EXTENDED, /*!< Extended/full range */
} XCamAfFocusRange;
