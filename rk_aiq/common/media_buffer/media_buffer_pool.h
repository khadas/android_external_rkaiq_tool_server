 ...
 */
typedef void (*MediaBufPoolCbNotify_t)(void* pUserContext,
                                       const MediaBuffer_t* pMediaBuffer //!< Just for information purposes, may be used
                                                                         //!< to handle chained ancillary buffers.
);
...
typedef struct MediaBufPoolConfig_s {
    ...
    uint32_t metaDataSizeMediaBuf; /**< Size of extra meta data strutucture attached to each Media buffer (pointed to by
                                      MediaBuffer_t.pMetaData) */
 ...
 * @return  Status of operation.
 *****************************************************************************/
extern RESULT MediaBufPoolCreate(MediaBufPool_t* pBufPool, MediaBufPoolConfig_t* pPoolConfig,
 ...
 * @return  Status of operation.
 *****************************************************************************/
extern RESULT MediaBufPoolRegisterCb(MediaBufPool_t* pBufPool, MediaBufPoolCbNotify_t fpCallback, void* pUserContext);
 ...
 * @return  Status of operation.
 *****************************************************************************/
extern RESULT MediaBufPoolDeregisterCb(MediaBufPool_t* pBufPool, MediaBufPoolCbNotify_t fpCallback);
