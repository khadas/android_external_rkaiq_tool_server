...
template <class T> struct rk_aiq_isp_params_t : public XCam::BufferData {
    T result;
...
static const char* AnalyzerGroupType2Str[32] = {
    ...
    [RK_AIQ_CORE_ANALYZE_AWB] = "GRP_AWB",     [RK_AIQ_CORE_ANALYZE_GRP0] = "GRP0",
    [RK_AIQ_CORE_ANALYZE_GRP1] = "GRP1",       [RK_AIQ_CORE_ANALYZE_AF] = "AF",
    [RK_AIQ_CORE_ANALYZE_EIS] = "EIS",         [RK_AIQ_CORE_ANALYZE_ORB] = "ORB",
};
