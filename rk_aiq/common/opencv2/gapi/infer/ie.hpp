...
namespace cv
{
    namespace gapi
    {
        ...
        namespace ie
        {
            ...
            template <typename Net> struct PortCfg {
            ...
            template <typename Net> class Params
            {
              public:
                ...
                Params<Net>& cfgInputLayers(const typename PortCfg<Net>::In& ll)
                {
                    ...
                    std::copy(ll.begin(), ll.end(), std::back_inserter(desc.input_names));
                    return *this;
                }
                ...
                Params<Net>& cfgOutputLayers(const typename PortCfg<Net>::Out& ll)
                {
                    ...
                    std::copy(ll.begin(), ll.end(), std::back_inserter(desc.output_names));
                    return *this;
                }
