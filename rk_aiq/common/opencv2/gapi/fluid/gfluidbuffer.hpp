        ...
        namespace fluid
        {
            ...
            class GAPI_EXPORTS View
            {
              public:
                ...
                {
                    return m_cache->m_desc.size.width;
                }
                int y() const;

                inline const GMatDesc& meta() const
                {
                    return m_cache->m_desc;
                }
            ...
            class GAPI_EXPORTS Buffer
            {
              public:
                ...
                Buffer(const cv::GMatDesc& desc, int max_line_consumption, int border_size, int skew, int wlpi,
                       BorderOpt border);
