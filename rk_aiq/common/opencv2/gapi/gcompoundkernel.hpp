...
namespace cv
{
    ...
    namespace detail
    {
        ...
        template <typename, typename, typename> struct GCompoundCallHelper;
        ...
        struct GCompoundCallHelper<Impl, std::tuple<Ins...>, std::tuple<Outs...>> {
            ...
            {
                expand_impl(ctx, typename detail::MkSeq<sizeof...(Ins)>::type(),
        ...
        class GCompoundKernelImpl
            : public cv::detail::GCompoundCallHelper<Impl, typename K::InArgs, typename K::OutArgs>,
              public cv::detail::KernelTag
        {
          ...
          public:
            ...
            {
                return cv::gapi::compound::backend();
            }
            static GCompoundKernel kernel()
            {
                return GCompoundKernel(&P::expand);
            }
        };
