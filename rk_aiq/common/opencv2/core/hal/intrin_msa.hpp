...
#define OPENCV_HAL_IMPL_MSA_PACK(_Tpvec, _Tpwvec, pack, mov, rshr)                                                     \
    ...
    template <int n> inline _Tpvec v_rshr_##pack(const _Tpwvec& a, const _Tpwvec& b)                                   \
    {                                                                                                                  \
...
#define OPENCV_HAL_IMPL_MSA_PACK_STORE(_Tpvec, _Tp, hreg, suffix, _Tpwvec, pack, mov, rshr)                            \
    ...
    template <int n> inline void v_rshr_##pack##_store(_Tp* ptr, const _Tpwvec& a)                                     \
    {                                                                                                                  \
...
#define OPENCV_HAL_IMPL_MSA_FLT_BIT_OP(bin_op, intrin)                                                                 \
    ...
    {                                                                                                                  \
        return v_float32x4(                                                                                            \
            MSA_TPV_REINTERPRET(v4f32, intrin(MSA_TPV_REINTERPRET(v4i32, a.val), MSA_TPV_REINTERPRET(v4i32, b.val)))); \
    }                                                                                                                  \
...
#define OPENCV_HAL_IMPL_MSA_DBL_BIT_OP(bin_op, intrin)                                                                 \
    ...
    {                                                                                                                  \
        return v_float64x2(                                                                                            \
            MSA_TPV_REINTERPRET(v2f64, intrin(MSA_TPV_REINTERPRET(v2i64, a.val), MSA_TPV_REINTERPRET(v2i64, b.val)))); \
    }                                                                                                                  \
...
#define OPENCV_HAL_IMPL_MSA_ROTATE_OP(_Tpvec, _Tpv, _Tpvs, suffix)                                                     \
    ...
    {                                                                                                                  \
        return _Tpvec(MSA_TPV_REINTERPRET(                                                                             \
            _Tpv, msa_extq_##suffix(MSA_TPV_REINTERPRET(_Tpvs, a.val), msa_dupq_n_##suffix(0), n)));                   \
    }                                                                                                                  \
    template <int n> inline _Tpvec v_rotate_left(const _Tpvec& a)                                                      \
    {                                                                                                                  \
        return _Tpvec(MSA_TPV_REINTERPRET(                                                                             \
            _Tpv, msa_extq_##suffix(msa_dupq_n_##suffix(0), MSA_TPV_REINTERPRET(_Tpvs, a.val), _Tpvec::nlanes - n)));  \
    }                                                                                                                  \
    ...
    {                                                                                                                  \
        return _Tpvec(MSA_TPV_REINTERPRET(                                                                             \
            _Tpv, msa_extq_##suffix(MSA_TPV_REINTERPRET(_Tpvs, a.val), MSA_TPV_REINTERPRET(_Tpvs, b.val), n)));        \
    }                                                                                                                  \
    template <int n> inline _Tpvec v_rotate_left(const _Tpvec& a, const _Tpvec& b)                                     \
    {                                                                                                                  \
        return _Tpvec(                                                                                                 \
            MSA_TPV_REINTERPRET(_Tpv, msa_extq_##suffix(MSA_TPV_REINTERPRET(_Tpvs, b.val),                             \
                                                        MSA_TPV_REINTERPRET(_Tpvs, a.val), _Tpvec::nlanes - n)));      \
    }                                                                                                                  \
...
#define OPENCV_HAL_IMPL_MSA_LOADSTORE_OP(_Tpvec, _Tp, suffix)                                                          \
    ...
    {
        v_uint8x16 c = v_uint8x16((v16u8)__builtin_msa_vshf_b((v16i8)((v2i64){0x08090A0B0C0D0E0F, 0x0001020304050607}),
    ...
    {
        v_uint16x8 c = v_uint16x8((v8u16)__builtin_msa_vshf_h((v8i16)((v2i64){0x0004000500060007, 0x0000000100020003}),
                                     ...
                                     const v_float32x4& d)
    {
        v4f32 u0 = msa_addq_f32(
            MSA_TPV_REINTERPRET(v4f32,
                                msa_ilvevq_s32(MSA_TPV_REINTERPRET(v4i32, b.val), MSA_TPV_REINTERPRET(v4i32, a.val))),
            MSA_TPV_REINTERPRET(v4f32, msa_ilvodq_s32(MSA_TPV_REINTERPRET(v4i32, b.val),
                                                      MSA_TPV_REINTERPRET(v4i32, a.val)))); // a0+a1 b0+b1 a2+a3 b2+b3
        v4f32 u1 = msa_addq_f32(
            MSA_TPV_REINTERPRET(v4f32,
                                msa_ilvevq_s32(MSA_TPV_REINTERPRET(v4i32, d.val), MSA_TPV_REINTERPRET(v4i32, c.val))),
            MSA_TPV_REINTERPRET(v4f32, msa_ilvodq_s32(MSA_TPV_REINTERPRET(v4i32, d.val),
                                                      MSA_TPV_REINTERPRET(v4i32, c.val)))); // c0+c1 d0+d1 c2+c3 d2+d3

        return v_float32x4(msa_addq_f32(
            MSA_TPV_REINTERPRET(v4f32, msa_ilvrq_s64(MSA_TPV_REINTERPRET(v2i64, u1), MSA_TPV_REINTERPRET(v2i64, u0))),
...
#define OPENCV_HAL_IMPL_MSA_EXPAND(_Tpvec, _Tpwvec, _Tp, suffix, ssuffix, _Tpv, _Tpvs)                                 \
    ...
    {                                                                                                                  \
        _Tpv a_lo = MSA_TPV_REINTERPRET(                                                                               \
            _Tpv, msa_ilvrq_##ssuffix(MSA_TPV_REINTERPRET(_Tpvs, a.val), msa_dupq_n_##ssuffix(0)));                    \
        _Tpv a_hi = MSA_TPV_REINTERPRET(                                                                               \
            _Tpv, msa_ilvlq_##ssuffix(MSA_TPV_REINTERPRET(_Tpvs, a.val), msa_dupq_n_##ssuffix(0)));                    \
...
#define OPENCV_HAL_IMPL_MSA_UNPACKS(_Tpvec, _Tpv, _Tpvs, ssuffix)                                                      \
    ...
    {                                                                                                                  \
        b0.val = MSA_TPV_REINTERPRET(                                                                                  \
            _Tpv, msa_ilvrq_##ssuffix(MSA_TPV_REINTERPRET(_Tpvs, a1.val), MSA_TPV_REINTERPRET(_Tpvs, a0.val)));        \
        b1.val = MSA_TPV_REINTERPRET(                                                                                  \
            _Tpv, msa_ilvlq_##ssuffix(MSA_TPV_REINTERPRET(_Tpvs, a1.val), MSA_TPV_REINTERPRET(_Tpvs, a0.val)));        \
    }                                                                                                                  \
    inline _Tpvec v_combine_low(const _Tpvec& a, const _Tpvec& b)                                                      \
    {                                                                                                                  \
        return _Tpvec(MSA_TPV_REINTERPRET(                                                                             \
            _Tpv, msa_ilvrq_s64(MSA_TPV_REINTERPRET(v2i64, b.val), MSA_TPV_REINTERPRET(v2i64, a.val))));               \
    }                                                                                                                  \
    inline _Tpvec v_combine_high(const _Tpvec& a, const _Tpvec& b)                                                     \
    {                                                                                                                  \
        return _Tpvec(MSA_TPV_REINTERPRET(                                                                             \
            _Tpv, msa_ilvlq_s64(MSA_TPV_REINTERPRET(v2i64, b.val), MSA_TPV_REINTERPRET(v2i64, a.val))));               \
    }                                                                                                                  \
...
#define OPENCV_HAL_IMPL_MSA_EXTRACT(_Tpvec, _Tpv, _Tpvs, suffix)                                                       \
    ...
    {                                                                                                                  \
        return _Tpvec(MSA_TPV_REINTERPRET(                                                                             \
            _Tpv, msa_extq_##suffix(MSA_TPV_REINTERPRET(_Tpvs, a.val), MSA_TPV_REINTERPRET(_Tpvs, b.val), s)));        \
    }
    ...
    inline v_int32x4 v_floor(const v_float64x2& a)
    {
        ...
        return v_int32x4(
            msa_pack_s64(msa_addq_s64(msa_cvttruncq_s64_f64(a1), MSA_TPV_REINTERPRET(v2i64, msa_cgtq_f64(a1, a.val))),
                         msa_dupq_n_s64(0)));
    }
    ...
    inline v_int32x4 v_ceil(const v_float64x2& a)
    {
        v2f64 a1 = msa_cvtrintq_f64(a.val);
        return v_int32x4(
            msa_pack_s64(msa_subq_s64(msa_cvttruncq_s64_f64(a1), MSA_TPV_REINTERPRET(v2i64, msa_cgtq_f64(a.val, a1))),
                         msa_dupq_n_s64(0)));
    }
...
#define OPENCV_HAL_IMPL_MSA_TRANSPOSE4x4(_Tpvec, _Tpv, _Tpvs, ssuffix)                                                 \
    ...
    {                                                                                                                  \
        ...
        _Tpv t10 = MSA_TPV_REINTERPRET(                                                                                \
            _Tpv, msa_ilvrq_##ssuffix(MSA_TPV_REINTERPRET(_Tpvs, a3.val), MSA_TPV_REINTERPRET(_Tpvs, a2.val)));        \
        _Tpv t11 = MSA_TPV_REINTERPRET(                                                                                \
            _Tpv, msa_ilvlq_##ssuffix(MSA_TPV_REINTERPRET(_Tpvs, a3.val), MSA_TPV_REINTERPRET(_Tpvs, a2.val)));        \
        b0.val = MSA_TPV_REINTERPRET(_Tpv,                                                                             \
                                     msa_ilvrq_s64(MSA_TPV_REINTERPRET(v2i64, t10), MSA_TPV_REINTERPRET(v2i64, t00))); \
        b1.val = MSA_TPV_REINTERPRET(_Tpv,                                                                             \
                                     msa_ilvlq_s64(MSA_TPV_REINTERPRET(v2i64, t10), MSA_TPV_REINTERPRET(v2i64, t00))); \
        b2.val = MSA_TPV_REINTERPRET(_Tpv,                                                                             \
                                     msa_ilvrq_s64(MSA_TPV_REINTERPRET(v2i64, t11), MSA_TPV_REINTERPRET(v2i64, t01))); \
        b3.val = MSA_TPV_REINTERPRET(_Tpv,                                                                             \
                                     msa_ilvlq_s64(MSA_TPV_REINTERPRET(v2i64, t11), MSA_TPV_REINTERPRET(v2i64, t01))); \
    }
...
#define OPENCV_HAL_IMPL_MSA_INTERLEAVED(_Tpvec, _Tp, suffix)                                                           \
    ...
    inline void v_load_deinterleave(const _Tp* ptr, v_##_Tpvec& a, v_##_Tpvec& b, v_##_Tpvec& c, v_##_Tpvec& d)        \
    {                                                                                                                  \
    ...
    {                                                                                                                  \
        msa_st4q_##suffix(ptr, a.val, b.val, c.val, d.val);                                                            \
                ...
                OPENCV_HAL_IMPL_MSA_INTERLEAVED(uint8x16, uchar, u8) OPENCV_HAL_IMPL_MSA_INTERLEAVED(int8x16, schar, s8)
    ...
    inline v_int8x16 v_lut(const schar* tab, const int* idx)
    {
        schar CV_DECL_ALIGNED(32)
            elems[16] = {tab[idx[0]],  tab[idx[1]],  tab[idx[2]],  tab[idx[3]], tab[idx[4]],  tab[idx[5]],
    ...
    {
        schar CV_DECL_ALIGNED(32)
            elems[16] = {tab[idx[0]], tab[idx[0] + 1], tab[idx[1]], tab[idx[1] + 1], tab[idx[2]], tab[idx[2] + 1],
    ...
    {
        schar CV_DECL_ALIGNED(32) elems[16] = {tab[idx[0]], tab[idx[0] + 1], tab[idx[0] + 2], tab[idx[0] + 3],
    ...
    {
        short CV_DECL_ALIGNED(32) elems[8] = {tab[idx[0]], tab[idx[1]], tab[idx[2]], tab[idx[3]],
                                              tab[idx[4]], tab[idx[5]], tab[idx[6]], tab[idx[7]]};
        return v_int16x8(msa_ld1q_s16(elems));
    }
    inline v_int16x8 v_lut_pairs(const short* tab, const int* idx)
    {
        short CV_DECL_ALIGNED(32) elems[8] = {tab[idx[0]], tab[idx[0] + 1], tab[idx[1]], tab[idx[1] + 1],
    ...
    {
        int CV_DECL_ALIGNED(32) elems[4] = {tab[idx[0]], tab[idx[1]], tab[idx[2]], tab[idx[3]]};
    ...
    {
        float CV_DECL_ALIGNED(32) elems[4] = {tab[idx[0]], tab[idx[1]], tab[idx[2]], tab[idx[3]]};
        return v_float32x4(msa_ld1q_f32(elems));
    }
    inline v_float32x4 v_lut_pairs(const float* tab, const int* idx)
    {
        uint64 CV_DECL_ALIGNED(32) elems[2] = {*(uint64*)(tab + idx[0]), *(uint64*)(tab + idx[1])};
    ...
    inline v_uint32x4 v_lut(const unsigned* tab, const v_int32x4& idxvec)
    {
        unsigned CV_DECL_ALIGNED(32)
            elems[4] = {tab[msa_getq_lane_s32(idxvec.val, 0)], tab[msa_getq_lane_s32(idxvec.val, 1)],
                        tab[msa_getq_lane_s32(idxvec.val, 2)], tab[msa_getq_lane_s32(idxvec.val, 3)]};
    ...
    inline void v_lut_deinterleave(const float* tab, const v_int32x4& idxvec, v_float32x4& x, v_float32x4& y)
    {
        ...
        x = v_float32x4(MSA_TPV_REINTERPRET(
            v4f32, msa_ilvevq_s32(MSA_TPV_REINTERPRET(v4i32, xy13), MSA_TPV_REINTERPRET(v4i32, xy02))));
        y = v_float32x4(MSA_TPV_REINTERPRET(
            v4f32, msa_ilvodq_s32(MSA_TPV_REINTERPRET(v4i32, xy13), MSA_TPV_REINTERPRET(v4i32, xy02))));
    }

    inline v_int8x16 v_interleave_pairs(const v_int8x16& vec)
    {
        v_int8x16 c = v_int8x16(
            __builtin_msa_vshf_b((v16i8)((v2i64){0x0705060403010200, 0x0F0D0E0C0B090A08}), msa_dupq_n_s8(0), vec.val));
        return c;
    }
    ...
    {
        v_int8x16 c = v_int8x16(
            __builtin_msa_vshf_b((v16i8)((v2i64){0x0703060205010400, 0x0F0B0E0A0D090C08}), msa_dupq_n_s8(0), vec.val));
        return c;
    }
    ...
    {
        v_int16x8 c = v_int16x8(
            __builtin_msa_vshf_h((v8i16)((v2i64){0x0003000100020000, 0x0007000500060004}), msa_dupq_n_s16(0), vec.val));
        return c;
    }
    ...
    {
        v_int16x8 c = v_int16x8(
            __builtin_msa_vshf_h((v8i16)((v2i64){0x0005000100040000, 0x0007000300060002}), msa_dupq_n_s16(0), vec.val));
        return c;
    }
    ...
    {
        v_int8x16 c = v_int8x16(
            __builtin_msa_vshf_b((v16i8)((v2i64){0x0908060504020100, 0x131211100E0D0C0A}), msa_dupq_n_s8(0), vec.val));
        return c;
    }
    ...
    {
        v_int16x8 c = v_int16x8(
            __builtin_msa_vshf_h((v8i16)((v2i64){0x0004000200010000, 0x0009000800060005}), msa_dupq_n_s16(0), vec.val));
        return c;
    }
    ...
    inline void v_lut_deinterleave(const double* tab, const v_int32x4& idxvec, v_float64x2& x, v_float64x2& y)
    {
        ...
        x = v_float64x2(MSA_TPV_REINTERPRET(
            v2f64, msa_ilvevq_s64(MSA_TPV_REINTERPRET(v2i64, xy1), MSA_TPV_REINTERPRET(v2i64, xy0))));
        y = v_float64x2(MSA_TPV_REINTERPRET(
            v2f64, msa_ilvodq_s64(MSA_TPV_REINTERPRET(v2i64, xy1), MSA_TPV_REINTERPRET(v2i64, xy0))));
    }
