...
namespace cv
{
    namespace utils
    {
        namespace fs
        {
             ...
             * @param pattern filter pattern (based on '*'/'?' symbols). Use empty string to disable filtering and
             * return all results
             ...
             * @return Path to cache directory. Returns empty string if cache directories support is not available.
             * Returns "disabled" if cache disabled by user.
             */
