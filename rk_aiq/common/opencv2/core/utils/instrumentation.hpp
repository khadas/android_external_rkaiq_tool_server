...
namespace cv
{
    ...
    // Each implementation entry correspond to function name entry, so you can find which implementation was executed in
    // which function
    ...
    namespace instr
    {
        ...
        static inline void setFlags(int modeFlags)
        {
