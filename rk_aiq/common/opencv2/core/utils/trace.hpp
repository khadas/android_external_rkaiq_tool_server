...
//! Trace code scope.
//! @note Dynamic names are not supported in this macro (on stack or heap). Use string literals here only, like
//! "initialize".
...
#define CV_TRACE_NS cv::utils::trace
    ...
    #define CV_TRACE_FILENAME __FILE__
        ...
        #define CV__TRACE_FUNCTION "<unknown>"
                 ...
                 * @param value argument value (can by dynamic string literal in case of string, static allocation is
                 * not required)
                 */
...
#define CV__TRACE_DEFINE_LOCATION_(loc_id, name, flags)                                                                \
    ...
    static const CV_TRACE_NS::details::Region::LocationStaticStorage CV__TRACE_LOCATION_VARNAME(loc_id) = {            \
        &(CV__TRACE_LOCATION_EXTRA_VARNAME(loc_id)), name, CV_TRACE_FILENAME, __LINE__, flags};

#define CV__TRACE_DEFINE_LOCATION_FN(name, flags)                                                                      \
    CV__TRACE_DEFINE_LOCATION_(fn, name, ((flags) | CV_TRACE_NS::details::REGION_FLAG_FUNCTION))
...
#define CV__TRACE_REGION_NEXT(name_as_static_string_literal)                                                           \
    CV__TRACE_REGION_(name_as_static_string_literal, CV_TRACE_NS::details::REGION_FLAG_REGION_NEXT)
...
#define CV__TRACE_DEFINE_ARG_(arg_id, name, flags)                                                                     \
    ...
    static const CV_TRACE_NS::details::TraceArg CV__TRACE_ARG_VARNAME(arg_id) = {                                      \
        &(CV__TRACE_ARG_EXTRA_VARNAME(arg_id)), name, flags};
