...
namespace RkCam
{
    ...
    template <typename T> class SharedItemProxy : public SharedItemBase
    {
      public:
        ...
        template <class U = T>
        typename std::enable_if<(std::is_same<U, RkAiqFullParams>::value || std::is_same<U, RkAiqIspStats>::value ||
    ...
    template <typename T> class SharedItemPool : public BufferPool
    {
